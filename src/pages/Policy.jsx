...
*Please note: After the data is deleted, you will no longer have access to your EVOFLIX MOVIES account, and the action is irreversible*`
  },
  {
    title: "3. How to Submit a Data Deletion Request",
    content: `To request the deletion of your data:

- Email Request: Send an email to evoflixmovies@gmail.com with the subject line \"Data Deletion Request.\"
...
- You will lose access to your EVOFLIX MOVIES account.
...
export const Policy = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black p-6 max-w-7xl mx-auto grid grid-cols-2 lD:grid-cols-2 lm:grid-cols-1 gap-8 items-center">
      {/* SVG Section */}
