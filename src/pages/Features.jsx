...
export const Features = () => {
  ...
  const features = [
    ...
    { id: 3, title: "Live TV", description: "MovaFlix offers a collection of over 40+ live TV channels, primarily targeting Indian audiences. Regardless of your location, you can download the MovaFlix app and begin enjoying your favorite programs on various broadcasters." },
  ];
    ...
    <section id="Features" className="py-12">
      <div className="max-w-[92%] mx-auto px-6 justify-between flex vtb:flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-[45%] vtb:w-full vtb:mt-8 md:w-1/2">
          <h2 className="text-4xl mb-6  text-center md:text-left">Experience Entertainment Like Never Before</h2>
